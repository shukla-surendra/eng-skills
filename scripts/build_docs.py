...
# `source/` holds the raw Google-Docs exports (base64-heavy originals) - never
...
<div class="shell shell--home">
  ...
  <main class="content home" id="content">
    <section class="hero">
      <span class="hero-badge">Personal collection &middot; for revision</span>
      <h1>{site}</h1>
      <p class="hero-sub">My <strong>vocabulary</strong>, <strong>phrasal verbs</strong>,
      <strong>idioms</strong>, and <strong>explanations</strong> collected over time
      &mdash; cleaned up, indexed A&ndash;Z, and searchable from anywhere.</p>
