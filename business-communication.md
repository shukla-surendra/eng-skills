...
- [A phrase with “could,” “might,” “should,” “would” or another modal verb](#a-phrase-with-could-might-should-would-or-another-modal-verb)
- [Making Suggestions](#making-suggestions)
- [Let’s + [verb]](#lets--verb)
- [Why don’t we + [verb]](#why-dont-we--verb)
- [How about + [“-ing” verb]](#how-about---ing-verb)
- [What if we + [verb]](#what-if-we--verb)
- [I think we + [modal verb] + [verb]](#i-think-we--modal-verb--verb)
- [Maybe we [modal verb] + [verb]](#maybe-we-modal-verb--verb)
- [That’s a good idea but…](#thats-a-good-idea-but)
- [Your suggestion sounds good but…](#your-suggestion-sounds-good-but)
- [I can see some problems with that.](#i-can-see-some-problems-with-that)
- [Let me think about this.](#let-me-think-about-this)
- [I’m not too keen on + [verb/noun]](#im-not-too-keen-on--verbnoun)
- [I’m not really + [adjective] + [noun/pronoun]](#im-not-really--adjective--nounpronoun)
- [I don’t think this would + [verb]](#i-dont-think-this-would--verb)
- [That’s a good idea./That’s not a bad idea.](#thats-a-good-ideathats-not-a-bad-idea)
- [This is just what we need.](#this-is-just-what-we-need)
- [Let’s try that.](#lets-try-that)
- [This looks like it could work.](#this-looks-like-it-could-work)
- [That might be worth trying.](#that-might-be-worth-trying)
- [It might work.](#it-might-work)
- [Maybe. I’m not sure.](#maybe-im-not-sure)
- [What do you suggest?](#what-do-you-suggest)
- [What are your thoughts?](#what-are-your-thoughts)
- [Do you think this will work?](#do-you-think-this-will-work)
- [Let’s look at this again.](#lets-look-at-this-again)
- [I think this needs a lot more thought.](#i-think-this-needs-a-lot-more-thought)
- [This idea has potential (possibilities), but it’s not quite there yet.](#this-idea-has-potential-possibilities-but-its-not-quite-there-yet)
- [Let’s keep this in mind and come back to it later.](#lets-keep-this-in-mind-and-come-back-to-it-later)
- [I agree up to a point.](#i-agree-up-to-a-point)
...
- [Overplay your hand](#overplay-your-hand)
- [Get down to business](#get-down-to-business)
- [Get down to brass tacks](#get-down-to-brass-tacks)
- [A ballpark number / figure / estimate](#a-ballpark-number--figure--estimate)
- [The bottom line](#the-bottom-line)
- [The big picture](#the-big-picture)
- [In a nutshell](#in-a-nutshell)
- [Gray area](#gray-area)
- [Red tape](#red-tape)
- [The wrong end of the stick](#the-wrong-end-of-the-stick)
...
- [There’s no “I” in team](#theres-no-i-in-team)
...
- [Need it yesterday](#need-it-yesterday)
- [ASAP](#asap)
- [24/7](#247)
- [To pencil it in](#to-pencil-it-in)
...
- [Run around in circles](#run-around-in-circles)
- [Get up to speed](#get-up-to-speed)
- [To keep an eye on the ball](#to-keep-an-eye-on-the-ball)
- [Hands are tied](#hands-are-tied)
- [Go down the drain](#go-down-the-drain)
- [By the book](#by-the-book)
- [Above board](#above-board)
- [To cut corners](#to-cut-corners)
- [Meetings Phrases](#meetings-phrases)
- [Back to the drawing board](#back-to-the-drawing-board-1)
- [Keep me in the loop](#keep-me-in-the-loop)
- [Drill down into](#drill-down-into)
- [As of yet](#as-of-yet)
- [Forward planning](#forward-planning)
- [Action points](#action-points)
- [To action/ Actionable](#to-action-actionable)
- [Get the ball rolling](#get-the-ball-rolling-1)
...
## A phrase with “could,” “might,” “should,” “would” or another modal verb
...
The ballpark is very large! So, this expression is specifically used for giving a very rough estimate or a large range in value.  
For example:
...
* **Go the extra mile**. To “go the extra mile” means to do more than what’s expected of you. There’s a story in the Bible of Jesus having told his disciples: “Whoever forces you to go one mile, go with him two.” This is thought to be where the term originated from.   
* **Cut corners.** When you “cut corners,” you do things as simply and easily as you can, even at the expense of quality. This is usually considered a negative thing.  
  The new filing system won’t work if we cut corners.  “To cut corners” is to complete a task in a fast and careless way. To do something without paying attention to details, thereby making mistakes or causing new problems.  
...
* Free online business English courses by Preply  
* The brand new course crafted by Preply language experts to help you navigate everyday business scenarios confidently  
*   
* 3. Call it a day  
...
* This extremely ungrammatical business phrase has become very common in offices. “Workflow,” unsurprisingly, refers to the pace that an employee is set tasks and expected to complete them by.   
* When someone says that they have “workflow issues,” they often mean that they are overworked. It places the blame on the “flow” of incoming tasks — i.e., communication within the workplace — rather than the work itself, which is quite smart, and a good way of explaining a missed deadline! In rare cases, the term “workflow issues” also describes not having enough work. Most companies actually use project management software to manage their workflows and projects to not have workflow issues.  
...
* To “touch base” with someone is to talk to them, whether digitally or in person, usually briefly. It usually describes keeping someone up-to-date with developments on something you are both working on.    
...
* To “reach out” is to get in contact with someone, usually a person who you do not know well. It is very common, but when you first hear it, seems like a very strange use of the word “reach,” which implies physical stretching!
...
* To “keep me/her/him/them in the loop” means to keep someone involved and updated about developments in a project. It comes from “looping” someone into an email chain — that is, cc’ing them into the digital conversation.   
...
* Many business terms make basic concepts sound complicated in order to come across a little more impressive, and this is one of them. “Forward planning” just means “planning,” since all planning is for activities that will take place in the future.   
* 
...
* It is not grammatical, but it is useful since it flags up that you intend to translate ideas from a discussion into practical results.  
* 
...
* Strictly speaking, the word “action” is a noun. However, in business English, it is often used as a verb. To “action” something just means to “do” it. The word “action” makes the mundane act of getting a task completed sound more dynamic and important!  
* Similarly, to describe something as “actionable” means that it is possible to get it done.   
* 15. Cut to the chase  
...
* Until very recently, “due diligence” was a term only used in a legal context. It used to describe the action that is considered reasonable for people to take in order to stay safe, and on the correct side of the law.   
* In business jargon, “due diligence” refers to the necessary research behind a good decision. If you have done your “due diligence,” then you have given an issue the attention it deserves and weighed alternatives to the solution you intend to take.

## Best practice

* The CEO decided that clear desks are best practice.   
* I uploaded it following all the SEO best practices.    
* A “best practice” is a method accepted to be the most effective means of doing something. They can be industry-wide or specific to a company. Many businesses encourage employees to follow a set of “best practices” described in a company handbook — that is, the rules, procedures and techniques to use in day-to-day operations. 

## Upskill

* We chose to upskill a junior employee rather than hire someone senior straight away.   
* This business term is another formal but ungrammatical replacement for an existing word: to train. To some, “upskilling” sounds more youthful than “training”.   
* 

## Dynamic

* We launched a dynamic new website in February.   
* The word “dynamic” is not exclusive to corporate speak, but it is over-used in professional life. It is often heard as a more office-friendly way of saying “exciting”, “interesting” or “new”. 
...
* If your boss says you “need to align” on something, that usually means a meeting is coming up soon.  

## Go the extra mile

* We always go the extra mile for our customers.   
* To “go the extra mile” is to put more effort into a task in order to gain a result which is even better than necessary. If someone says you “went the extra mile” on a project, they are praising your work ethic! 

## Expedite

* Can you ask Basil to expedite the payment process for this, please?   
* The word “expedite” is a little old-fashioned for standard conversation, but it is commonly heard in business English. It is a formal way of saying “speed up.”   
* 
...
* This is a negative word co-workers might use to discuss the behavior of controlling bosses. To “micromanage” someone means, literally, to manage them on a micro level. To watch the details of their work too closely, instead of giving them the chance to get on with it and take responsibility themselves. If your boss stands behind your desk and edits your emails, you might feel that they are “micromanaging” you. 
...
* It refers to an action that will start now and continue in the immediate future indefinitely.  
...
* “Let go” is a gentle way of discussing employees being fired or made redundant. It is more commonly heard than “fired” since it is considered much more polite.   
...
* This is one of the many English idioms which was stolen from the world of sport. In cricket, “close of play” refers to the end of a day’s matches. In the office, it refers to the end of the working day.  
